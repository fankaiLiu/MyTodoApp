...
- [ ] **任务数据库操作** - 完善 `backend/src/db/db_task.rs`
  ```
  基础 CRUD 操作：
  1. create_task() - 创建任务
...
- [ ] **团队数据库操作** - 完善 `backend/src/db/db_team.rs`
  ```
  基础 CRUD 操作：
  1. create_team() - 创建团队
...
#### 1.4 子团队数据库操作
- [ ] **子团队操作** - 创建 `backend/src/db/db_sub_team.rs`
  ```
  基础 CRUD 操作：
...
- [ ] **子团队成员操作** - 创建 `backend/src/db/db_sub_team_member.rs`
  ```
